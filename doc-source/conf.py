...
rst_prolog = f""".. |pkgname| replace:: cp2077-extractor
.. |pkgname2| replace:: ``cp2077-extractor``
...
from cp2077_extractor.cr2w import datatypes, header_structs, textures
from cp2077_extractor.cr2w.datatypes import CBitmapTexture, Chunk
